...
inline FMatrix4x4 CalculateProjectionMatrixLHS(float FOVRadians, float Aspect, float NearZ, float FarZ)
{
...
inline FMatrix4x4 CalculateProjectionMatrixRHS(float FOVRadians, float Aspect, float NearZ, float FarZ)
{
	const float HalfTanFOV = (float)tan(FOVRadians / 2.0);
	FMatrix4x4 New = FMatrix4x4::GetZero();
	New.Set(0, 0, 1.0f / (Aspect * HalfTanFOV));
